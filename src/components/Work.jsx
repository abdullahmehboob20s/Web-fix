    ...
    >
      <div className="max-w-5xl mx-auto p-4 flex flex-col justify-center w-full h-full">
        <div className="pb-8">
          ...
          <p className="-pb-4  pt-4">Check out some of my work</p>
        </div>
        {/* Container */}
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
          {/* Grid Item */}
          <div
            style={{ backgroundImage: `url(${ourImage})` }}
            className="shadow-lg shadow-blue-muddy group container rounded-md flex justify-center items-center mx-auto content-div"
          >
            {/* Hover Effects */}
            <div className="opacity-0 group-hover:opacity-100">
              ...
              <div className="pt-8 text-center">
                <a href="https://field-guide-birds.netlify.app">
                  <button className="text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-light font-bold text-lg">
                    Demo
                  </button>
                </a>
                <a href="/">
